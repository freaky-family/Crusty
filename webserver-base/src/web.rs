...
async fn led_handler(input: picoserve::extract::Json<LedRequest>) -> impl picoserve::response::IntoResponse {
    crate::led::LED_STATE.store(input.0.is_on, core::sync::atomic::Ordering::Relaxed);
